...
public class Receiver extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener,
        LocationListener, View.OnClickListener, ResultCallback<Status> {

    DatabaseReference ref,locationRef;
    GeoFire geoFire;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        locationRef = ref.child("/location/l");
